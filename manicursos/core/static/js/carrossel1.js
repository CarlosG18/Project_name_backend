const circles_nav = document.querySelectorAll('.circle-carrossel1')
const img1 = document.querySelector('.img4')
const img2 = document.querySelector('.img5')
const img3 = document.querySelector('.img6')
var index_auto = 0
